...
<body>
    <div class="box register">
        ...
        if (!isset($_COOKIE[$cookie_name])) { //verificação se o cookie está inativo
            ...
            <a class="btn btn-primary" href="http://'.$urlHome . '/projeto-sem-para/index.php" role="button">Home</a>            </div>';
                ...
                <h3><?php
                    ...
                    <div class="col-md-9 register-right"> 
                        ...
                        <ul class="nav nav-tabs nav-justified" id="myTab" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" id="newuser-tab" data-toggle="tab" href="http://<?php echo $urlHome; ?>/projeto-sem-para/index.php" role="tab" aria-controls="newuser" aria-selected="false">Outra consulta</a>
                            </li>
                        </ul>
