...
switch (sizeof($list)) { //laço que analiza o tamanho da lista CPF
    ...
    if ($cpfAtestar->segundodigitoehValido() == true) { //caso o CPF seja válido, vamos iniciar uma consulta com o servidor com seu valor
...
//erro caso ocorra
        ...
        if (strlen($response) > 169) { //se a conexão for um sucesso, retornará uma String de 169 caracteres, o qual faremos nossa verificação
...
//vamos armazenar a resposta em um formato JSON
            ...
            sleep(5); //se a resposta da requisição for um String menor que 169
    ...
    //dizer que se trata de uma CPF
            ...
            if ($cnpjAtestar->segundoDigitoCNPJehValido() == true) { //caso o CPF seja válido, vamos iniciar uma consulta com o servidor com seu valor
                $curl = curl_init(); 
