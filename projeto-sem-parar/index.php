      ...
      <div class="col-md-12"> <!-- sividade -->
        ...
        <div class="wrap">
          <form class="login" action="verificador.php" method="post" id="formulario"> <!-- incialização e estilização do formuário (classe Login) -->
            ...
            <p class="form-title">
            sign in</p> <!-- título com cor da Sem Parar -->
            <input type="text" class="form-ctrl" placeholder="CPF ou CNPJ"  id="CPF" name="chave" required /> <!-- CPF com máscara que alterna para CNPJ ao atingir a quantidade de 12 dígtos -->
            <div>
            <p id="fail" style="color: red;font-size: 10px;margin-bottom: 20px;"> </p>
              <p id="fail2" style='color:darkred; font-size: 10px;'>
                <?php
                    ...
                    <input type="submit" value="Verificar" id="botao" class="btn btn-danger btn-sm" />
                  ...
                  <a type="button" role="button" class="fixed-bottom btn btn-circle btn-xl" href="https://api.whatsapp.com/send/?phone=5511975141378&text=Ola&app_absent=0"><img id="zapzap" src="css/logo-whatsapp-transparente.png"></a> <!-- botão do Whatsapp que redireciona para o atendimento do Sem Parar -->
                  <a type="button" role="button" class="fixed-bottom btn btn-danger btn-circle" id="notify">1</a> <!-- botão do Whatsapp que redireciona para o atendimento do Sem Parar -->
                </div>
                <div>
